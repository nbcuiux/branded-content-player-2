...
export default class App extends Component {
	...
	addAiStarred = (o) => {
	    let starred = this.state.fullAiCardStarred;
	    starred.unshift(o);
		this.setState({
	...
	render() {
		...
		const AiPreviewShow = (isJustMouseMoved || isScrubbing || isVolumeDragging) && !(justClickedPlay || endCardShow || coverImgShow || showCCSettingsCalc || showShareCard || isVideoEnd) && !showFullAiCard;
